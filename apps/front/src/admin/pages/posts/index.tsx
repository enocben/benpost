...
import { useDeletePost, usePosts, statusLabels } from "@/admin/hooks/api";
import type { PostListItem, PostStatus } from "@/admin/types";
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link to={`/admin/posts/${row.original.id}/edit`}>
                <Pencil />
                Modifier
              </Link>
            </DropdownMenuItem>
